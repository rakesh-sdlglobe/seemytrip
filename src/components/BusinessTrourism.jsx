...
import { AirIndia, Bangalore, Delhi, Hyderabad, Indigo, indigo, Mumbai, Vistara } from '../assets/images';
  ...
  return (
    <div>
      ...
      <div id="main-wrapper">
        ...
        {/* ============================================================== */}
        {/* ============================ Hero Banner  Start================================== */}
        <div className="image-cover hero-header bg-white" style={{ background: 'url(../images/business.png)no-repeat' }} data-overlay={6}>
                  ...
                  <Link to="#" className="card rounded-3 border br-dashed h-100 m-0">
                    <div className="flight-thumb-wrapper">
                      <div className="popFlights-item-overHidden">
                        <img src={Hyderabad} className="img-fluid" alt="" />
                      </div>
                    </div>
...
export default BusinessTrourism;