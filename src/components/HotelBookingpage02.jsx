...
const HotelBookingpage02= ()=>{
                        ...
                        <div className="card mb-3">
                          ...
                          <div className="card-body">
                            <div className="row">
                              ...
                              <div className="col-xl-6 col-lg-6 col-md-6">
                                <div className="form-group">
                                  <label className="form-label">AdharNumber</label>
                                  <input type="text" className="form-control" placeholder="AdharNumber" />
                                </div>
                              </div>
                              <div className="col-xl-6 col-lg-6 col-md-6">
                                <div className="form-group">
    ...
    export default HotelBookingpage02;