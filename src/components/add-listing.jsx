                    ...
                    <div className="card rounded-3 mb-4">
                      ...
                      <div className="card-body">
                        <div className="row g-4">
                          ...
                          {/* Short description */}
                          <div className="col-12">
                            <iframe className="full-width ht-400 grayscale rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3022.9663095343008!2d-74.00425878428698!3d40.74076684379132!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c259bf5c1654f3%3A0xc80f9cfce5383d5d!2sGoogle!5e0!3m2!1sen!2sin!4v1586000412513!5m2!1sen!2sin" title="YouTube video: Example Title" height={500} style={{border: 0}} aria-hidden="false" tabIndex={0} />
                          </div>
                        </div>
                      </div>
                      {/* Card body END */}
                ...
                <div className="row align-items-start">
                  <div className="col-xl-12 col-lg-12 col-md-12">
                    <div className="text-center d-flex align-items-center justify-content-center mt-4">
                      <Link to="add-listing-step-02.html" className="btn btn-md btn-primary fw-semibold">Next<i className="fa-solid fa-arrow-right ms-2" /></Link>
                    </div>
                  </div>
                </div>
              </div>
