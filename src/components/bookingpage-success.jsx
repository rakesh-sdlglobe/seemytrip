                  ...
                  <div className="car-body px-xl-5 px-lg-4 py-lg-5 py-4 px-2">
                    <div className="d-flex align-items-center justify-content-center mb-3">
                      <div className="square--80 circle text-light bg-success">
                        <i className="fa-solid fa-check-double fs-1" />
                      </div>
                    </div>
                    ...
                    <div className="text-center d-flex align-items-center justify-content-center">
                      <Link
                        to="/"
                        className="btn btn-md btn-light-success fw-semibold mx-2 hover-button "
                      >
                        Book Next Tour
                      </Link>
                      <Link
                        ...
                        className="btn btn-md btn-light-primary fw-semibold mx-2 hover-button"
                      >
                        View Invoice Print
                      </Link>
                    </div>
