...
import { Carnival,Vistara, indigo } from '../../assets/images';

export const BtBookingPage = () => {
  return (
    <div>
      {/* Preloader */}
      <div id="preloader">
                        ...
                        <div className="row">
                          <div className="col-xl-4 col-lg-3 col-md">
                            <div className="cardImage__caps rounded-2 overflow-hidden h-100">
                              <img className="img-fluid h-100 object-fit" src={Vistara} alt="Cab" />
                            </div>
                          </div>
                          <div className="col-xl col-lg col-md">
                            <div className="listLayout_midCaps mt-md-0 mt-3 mb-md-0 mb-3">
                              ...
                              <h4 className="fs-5 fw-bold mb-1">Business Cab Booking</h4>
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-12">
                    <div className="side-block card rounded-2 p-3">
                      ...
                      <div className="mid-block rounded-2 border br-dashed p-2 mb-3">
                        ...
                        <div className="d-flex align-items-center justify-content-between mt-2">
                          <div className="d-inline-block text-muted-2 text-md">Cab Type</div>
                          <div className="d-inline-block fw-semibold text-dark text-md">  </div>
                        </div>
                        <div className="d-flex align-items-center justify-content-between mt-2">
                          <div className="d-inline-block text-muted-2 text-md">No. of Seats</div>
                          <div className="d-inline-block fw-semibold text-dark text-md">  </div>
                        </div>
                      </div>
                      <div className="total-cost text-dark fw-semibold fs-5">
                        <div className="d-flex align-items-center justify-content-between">
                      ...
                      <div className="d-grid gap-2 mt-3">
                        <Link to="/btBookingPayment" className="btn btn-primary">Proceed to Payment</Link>
                      </div>
                    </div>
                  </div>
                </div>
