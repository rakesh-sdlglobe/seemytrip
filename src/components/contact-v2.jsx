                    ...
                    <div className="card p-4 rounded-4 border br-dashed text-center h-100">
                      ...
                      <div className="crds-desc">
                        ...
                        <ul className="list-inline mb-0">
                          <li className="list-inline-item"> <Link className="square--40 circle gray-simple color--facebook" to="#"><i className="fa-brands fa-facebook-f" /></Link> </li>
                          <li className="list-inline-item"> <Link className="square--40 circle gray-simple color--instagram" to="#"><i className="fa-brands fa-instagram" /></Link> </li>
                          <li className="list-inline-item"> <Link className="square--40 circle gray-simple color--twitter" to="#"><i className="fa-brands fa-twitter" /></Link> </li>
                          <li className="list-inline-item"> <Link className="square--40 circle gray-simple color--dribbble" to="#"><i className="fa-brands fa-dribbble" /></Link> </li>
                        </ul>
                      </div>
                    </div>
                  </div>
