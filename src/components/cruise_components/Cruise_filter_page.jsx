        ...
        <div className="filter-searchBar-head border-bottom">
          <div className="searchBar-headerBody d-flex align-items-start justify-content-between px-3 py-3">
            <div className="searchBar-headerfirst">
              ...
              <p className="text-md text-muted m-0">Showing 180 Cruises</p>
            </div>
        ...
        <div className="filter-searchBar-body">
          ...
          <div className="searchBar-single px-3 py-3 border-bottom">
            <div className="searchBar-single-title d-flex mb-3">
              <h6 className="sidebar-subTitle fs-6 fw-medium m-0">Cruise Type</h6>
            </div>
            <div className="searchBar-single-wrap">
              <ul className="row align-items-center justify-content-between p-0 gx-3 gy-2 mb-0">
                ...
                <li className="col-6">
                  <input type="checkbox" className="btn-check" id="balcony" />
                  <label className="btn btn-sm btn-secondary rounded-1 fw-medium full-width" htmlFor="balcony">Balcony</label>
                </li>
                <li className="col-6">
                  <input type="checkbox" className="btn-check" id="family" />
                  <label className="btn btn-sm btn-secondary rounded-1 fw-medium full-width" htmlFor="family">Family</label>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="searchBar-single px-3 py-3 border-bottom">
            ...
            <div className="searchBar-single-wrap">
              <ul className="row align-items-center justify-content-between p-0 gx-3 gy-2 mb-0">
                ...
                <li className="col-12">
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="entertainment" />
                    <label className="form-check-label" htmlFor="entertainment">Entertainment Shows</label>
                  </div>
                </li>
              </ul>
            </div>
...
export default CruiseFilterpage;
