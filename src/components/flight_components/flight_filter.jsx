...
const FlightFilter = ({
  ...
  const getPriceRange = () => {
    if (
      !filters ||
      !filters.PriceRangeHotels ||
      filters.PriceRangeHotels.length === 0
    ) {
      return { min: 0, max: 50000 };
    }
    const prices = filters.PriceRangeHotels.filter(
      (x) => x.MaxPrice > x.MinPrice
        ...
        <div className="filter-searchBar-body">
          ...
          <div className="searchBar-single px-3 py-3 border-bottom">
            ...
            <div className="searchBar-single-wrap mb-4">
              <ul className="row align-items-center justify-content-between p-0 gx-3 gy-2">
                {filters.Filter && filters.Filter?.DepartureTime !== "" &&
            ...
            <div className="searchBar-single-title d-flex mb-3">
              <h6 className="sidebar-subTitle fs-6 fw-medium m-0">Arrival</h6>
            </div>
            ...
            {filters.Filter && filters.Filter?.ReturnDepartureTime !== "" && (<>
            <div className="searchBar-single-title d-flex mb-3">
              <h6 className="sidebar-subTitle fs-6 fw-medium m-0">Return Departure</h6>
            </div>
            <div className="searchBar-single-wrap mb-4">
              <ul className="row align-items-center justify-content-between p-0 gx-3 gy-2">
                  {filters.Filter && filters.Filter?.ReturnDepartureTime !== "" &&
                  filters.Filter?.ReturnDepartureTime?.split("|").map(
                    (dep, dpIdx) => (
                      <>
                        <li className="col-6">
                          <input
            ...
            {filters.Filter && filters.Filter?.ReturnArrivalTime !== "" && (<>
             <div className="searchBar-single-title d-flex mb-3">
              <h6 className="sidebar-subTitle fs-6 fw-medium m-0">Return Arrival</h6>
            </div>
            <div className="searchBar-single-wrap">
              <ul className="row align-items-center justify-content-between p-0 gx-3 gy-2">
          ...
          <div className="searchBar-single px-3 py-3 border-bottom">
            ...
            <div className="searchBar-single-wrap">
              <ul className="row align-items-center justify-content-between p-0 gx-3 gy-2">
                {filters.Filter &&
                  filters.Filter?.Airline?.split("|").map((arlne, arlIdx) => (
                    <>
                      <li className="col-12">
                          ...
                          <div className="frm-slicing d-flex align-items-center">
                            <div className="frm-slicing-end d-flex align-items-center justify-content-between full-width ps-1">
                              <div className="frms-flex d-flex align-items-center">
                                ...
                                <div className="frm-slicing-title ps-2">
                                  <span className="text-muted-2">{arlne}</span>
                                </div>
                              </div>
                            </div>
                          </div>
