                    ...
                    <div className="position-relative">
                      ...
                      <div className="d-flex align-items-start justify-content-start gap-3 flex-wrap mt-xl-5 mt-4">
                        ...
                        <div className="bannrHelp">
                          <Link to="#" data-bs-toggle="modal" data-bs-target="#popup-video" className="d-flex align-items-center justify-content-start gap-2">
                      ...
                      <div className="searchableHead">
                        <ul className="nav nav-tabs medium justify-content-center" id="tour-pills-tab" role="tablist">
                          <li className="nav-item">
                            <Link className="nav-link" data-bs-toggle="tab" to="#hotels"><i className="fa-solid fa-hotel me-2" />Hotels</Link>
                          </li>
                          <li className="nav-item">
                            <Link className="nav-link active" data-bs-toggle="tab" to="#flights"><i className="fa-solid fa-jet-fighter me-2" />Flights</Link>
                          </li>
                          <li className="nav-item">
                ...
                <div className="row justify-content-center gy-4 gx-3">
                  <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                    <div className="pop-touritem">
                      <Link to="#" className="card rounded-3 shadow-wrap h-100 m-0">
