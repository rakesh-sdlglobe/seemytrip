    ...
    <div>
      ...
      <div id="main-wrapper">
        ...
        <div
          ...
          style={{ background: "url(../images/Cruise.jpeg)no-repeat" }}
          data-overlay={5}
        >
              ...
              <div className="col-xl-9 col-lg-10 col-md-12 col-sm-12">
                <div className="position-relative text-center mb-5">
                  ...
                  <p className="fs-5 fw-light">
                    Take a little break from the everyday work stress. Plan a
                        ...
                        <div className="flts-flex d-flex align-items-end justify-content-between">
                          <div className="flts-flex-strat">
                            <div className="d-flex align-items-center justify-content-start">
                              <span className="label bg-light-danger text-danger">
                                15% Off
                              </span>
                            </div>
