...
export const HotelBookingPage = () => {
  console.log(" =====> Hotel Booking Page Rendered");
  ...
  const savedParams = JSON.parse(localStorage.getItem("hotelSearchParams"));
  ...
  // useEffect(() => {
  //   console.log("=======>  Wait i will call the API to fetch hotels list");
    
  //   dispatch(fetchHotelsList(cityId, checkInDate, checkOutDate, Rooms));
  // }, [dispatch, cityId, checkInDate, checkOutDate, Rooms]);
                        ...
                        <div className="row">
                          <div className="col-xl-4 col-lg-3 col-md">
                            <div className="cardImage__caps rounded-2 overflow-hidden h-100">
                              <img className="img-fluid h-100 object-fit" src={Hotel01} alt="image" />
                            </div>
                          </div>
