                ...
                <div className="row">
                  <div className="col-xl-12 col-lg-12 col-md-12">
                    <ul className="user-Dashboard-menu">
                      <li><Link to="my-profile.html"><i className="fa-regular fa-id-card me-2" />My Profile</Link></li>
                      ...
                      <li className="active"><Link to="payment-detail.html"><i className="fa-solid fa-wallet me-2" />Payment
                          Details</Link></li>
                              ...
                              <div className="bg-dark p-4 rounded-3">
                                <div className="d-flex justify-content-between align-items-start">
                                  ...
                                  <div className="dropdown">
                                    <Link className="text-white" to="#" id="creditcardDropdown" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                      {/* Dropdown Icon */}
                            ...
                            <div className="card h-100">
                              <div className="bg-seegreen p-4 rounded-3">
                                <div className="d-flex justify-content-between align-items-start">
                                  ...
                                  {/* Card action START */}
                                  <div className="dropdown">
                                    <Link className="text-white" to="#" id="creditcardDropdown1" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                                      {/* Dropdown Icon */}
                                      <svg width={24} height={24} fill="none">
                                        <circle fill="currentColor" cx="12.5" cy="3.5" r="2.5" />
                                        <circle fill="currentColor" opacity="0.5" cx="12.5" cy="11.5" r="2.5" />
                          ...
                          <div className="col-xl-2 col-lg-6 col-md-6">
                            <div className="card d-flex align-items-center justify-content-center border br-dashed border-2 py-3 h-100">
                              <div className="d-flex align-items-center justify-content-center">
                                <Link to="#" className="square--60 circle bg-light-primary text-primary fs-2" data-bs-toggle="modal" data-bs-target="#addcard"><i className="fa-solid fa-circle-plus" /></Link>
                              </div>
                            </div>
                          </div>
                        </div>
