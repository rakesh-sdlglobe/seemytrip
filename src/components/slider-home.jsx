                ...
                <div className="carousel-item active bg-cover" style={{background: 'url(https://placehold.co/2200x1200)no-repeat'}} data-overlay={6}>
                  <div className="container">
                    <div className="carousel-caption">
                      <h1>Start Your Trip with <span className="position-relative z-4">GeoTrip<span className="position-absolute top-50 start-50 translate-middle d-none d-md-block mt-4">
                      ...
                      <p className="mt-5"><Link className="btn btn-primary px-5" to="#">Explore More<i className="fa-solid fa-arrow-trend-up ms-2" /></Link></p>
                    </div>
                  </div>
                </div>
              ...
              <div className="container">
                ...
                <div className="row justify-content-center g-4">
                  <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="blogGrid-wrap d-flex flex-column h-100">
                      <div className="blogGrid-pics">
                        <Link to="#" className="d-block"><img src="https://placehold.co/1200x800" className="img-fluid rounded" alt="Blog" /></Link>
                      </div>
                  ...
                  <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                    <div className="blogGrid-wrap d-flex flex-column h-100">
                      <div className="blogGrid-pics">
                      <img src="https://placehold.co/1200x800" className="img-fluid rounded" alt="Blog" />
                      </div>
                      <div className="blogGrid-caps pt-3">
            ...
            <div className="modal fade" id="popup-video" tabIndex={-1} role="dialog" aria-labelledby="popupvideo" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered" role="document">
                <div className="modal-content" id="popupvideo">
                  <iframe className="embed-responsive-item full-width" height={480} src="https://www.youtube.com/embed/qN3OueBm9F4?rel=0" frameBorder={0} allowFullScreen  title="YouTube video: Example Title" />
                </div>
              </div>
            </div>
            {/* End Video Modal */}
