  ...
  return (
    <div>
      ...
      <div id="main-wrapper">
        <Header02 />
        <div className="clearfix" />
        <SearchComponent onSearchResults={handleSearchResults} backgroundColor="#cd2c22" height="130px" leavingLabel={null} checklabelColor="#ffffff" dropdownHindden= "none"     // Custom label for 'Leaving From'
